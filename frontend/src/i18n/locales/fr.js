export default {
  ...
  dashboard: {
    co2_daily: "CO2 / Jour",
    target_progress: "{percent}% de la limite quotidienne",
    points_title: "Mes Points",
    points_value: "+ {count} n2e points",
    leaderboard_title: "Classement quotidien des amis (live)",
    leaderboard_empty: "Pas encore de données de classement quotidien.",
    you: "(toi)",
    ...
    delete_activity: "Supprimer",
    deleting_activity: "Suppression...",
    delete_activity_title: "Supprimer l'activité ?",
    delete_activity_cancel: "Annuler",
    delete_activity_confirm_button: "Oui, supprimer",
    delete_activity_confirm:
      "Voulez-vous vraiment supprimer cette activité ? Cette action est irréversible.",
    unit: "unité",
  ...
  data: {
    ...
    total_points_label: "Points totaux",
    community_friends: "{count} amis",
    ...
    challenges: {
      ...
      trend_down: "-{value}% vs semaine précédente",
      trend_up: "+{value}% vs semaine précédente",
    },
    chart: {
      transport: "Transport",
      food: "Alimentation",
  ...
  map: {
    ...
    recenter: "Recentrer",
    rank_place: "{rank}/{total} place aujourd'hui",
    points_value: "{points} pts",
    rank_label: "Classement quotidien {rank}/{total}",
  },
  profile: {
  ...
  friends_page: {
    ...
    no_received_requests: "Aucune demande en attente.",
    site_users: "Utilisateurs du site",
    add: "Ajouter",
    accept: "Accepter",
