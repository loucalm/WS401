    ...
    >
      ...
      <section class="mt-8 px-4 grid grid-cols-1 gap-6 relative z-20">
        ...
        >
          ...
          >
            <p
              class="text-body-12 text-grey font-bold italic mb-4 uppercase tracking-tighter"
            >
              kg CO2
            </p>
            ...
            <div class="flex justify-between mt-4">
              <div
                ...
                :key="index"
                class="text-body-8 text-center font-bold text-black flex-1 uppercase leading-tight"
              >
                {{ label }}<br /><span class="font-normal text-grey"
